...
<div class="container" align="center">
  <br>
    <?php
         include "koneksi.php";
         $token=$_GET['t'];
         $sql_cek=mysqli_query($koneksi,"SELECT * FROM tb_login WHERE token='".$token."' and aktif='0'");
         $jml_data=mysqli_num_rows($sql_cek);
         if ($jml_data>0) {
             //update data users aktif
             mysqli_query($koneksi,"UPDATE tb_login SET aktif='1' WHERE token='".$token."' and aktif='0'");
