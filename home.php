                ...
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
                            ...
                            <li class="active">
                                <a href="?pages=" aria-expanded="true"><i class="ti-palette"></i><span>dashboard</span></a>
                                <ul class="collapse">
                                    <li class="active"><a href="?pages=mobil">Lihat Data</a></li>
        ...
        <div class="main-content">
                ...
                <div class="row align-items-center">
                    <div class="col-sm-12 clearfix">
                        <div class="user-profile pull-right">
                            <img class="avatar user-thumb" src="<?php echo $_SESSION['image'] ?>" alt="avatar">
                            <h4 class="user-name dropdown-toggle" data-toggle="dropdown"><?php echo $_SESSION['name'] ?><i class="fa fa-angle-down"></i></h4>
                            <div class="dropdown-menu">
                                <a class="dropdown-item" href="?pages=mobil&action=editprofil">Profil</a>
                                <a class="dropdown-item" href="https://www.google.com/accounts/Logout?continue=https://appengine.google.com/_ah/logout?continue=https://phpfirstapps.000webhostapp.com/">Log Out</a>
            ...
            <?php
                ...
                if($page=="mobil"){
                    ...
                    echo "Selamat datang dihalaman utama {$_SESSION['name']}";
                }else{
